...
<link rel="alternate" type="application/rss+xml" title="Friends For Life &raquo; Comments Feed" href="comments/feed/index.html" />
		...
		<script>
window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/15.0.3\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/15.0.3\/svg\/","svgExt":".svg","source":{"concatemoji":"https:\/\/denzel.blec.co.za\/wp-includes\/js\/wp-emoji-release.min.js?ver=6.5.3"}};
...
<style id='wp-emoji-styles-inline-css'>
 ...
 <!-- Stylesheets -->
 	<link rel="stylesheet" href="{{ asset('plugins/yith-woocommerce-wishlist/assets/css/jquery.selectBox7359.css') }}" id="jquery-selectBox-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/yith-woocommerce-wishlist/assets/css/font-awesome1849.css') }}" id="yith-wcwl-font-awesome-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/woocommerce/assets/css/prettyPhoto005e.css') }}" id="woocommerce_prettyPhoto_css-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/yith-woocommerce-wishlist/assets/css/style575b.css') }}" id="yith-wcwl-main-css" media="all">
...
<link rel='stylesheet' id='contact-form-7-css' href="{{ asset('plugins/contact-form-7/includes/css/styles7404.css?ver=5.9.3') }}" media='all' />
<style id='woocommerce-inline-inline-css'>
.woocommerce form .form-row .required { visibility: visible; }
</style>
	<link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/animate/animate.mind4b5.css') }}" id="animate-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/bootstrap-select/css/bootstrap-select.mind4b5.css') }}" id="bootstrap-select-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/bxslider/jquery.bxsliderd4b5.css') }}" id="bxslider-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/jarallax/jarallaxd4b5.css') }}" id="jarallax-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/jquery-magnific-popup/jquery.magnific-popupd4b5.css') }}" id="jquery-magnific-popup-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/odometer/odometer.mind4b5.css') }}" id="odometer-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/owl-carousel/owl.carousel.mind4b5.css') }}" id="owl-carousel-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/owl-carousel/owl.theme.default.mind4b5.css') }}" id="owl-theme-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/reey-font/stylesheetd4b5.css') }}" id="reey-font-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/elementor/assets/lib/swiper/v8/css/swiper.min94a4.css') }}" id="swiper-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/nice-select/nice-selectd4b5.css') }}" id="nice-select-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/ion.rangeSlider/css/ion.rangeSlider.mind4b5.css') }}" id="rangeSlider-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/css/insur-addond4b5.css') }}" id="insur-addon-style-css" media="all">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=DM+Sans%3A400%2C400i%2C500%2C500i%2C700%2C700i%26subset%3Dlatin%2Clatin-ext" id="insur-fonts-css" media="all">
    <link rel="stylesheet" href="{{ asset('themes/insur/assets/vendors/insur-icons/style5152.css') }}" id="insur-icons-css" media="all">
    <link rel="stylesheet" href="{{ asset('themes/insur/assets/vendors/bootstrap/css/bootstrap.minbb93.css') }}" id="bootstrap-css" media="all">
    <link rel="stylesheet" href="{{ asset('themes/insur/assets/vendors/fontawesome/css/all.min9e0b.css') }}" id="fontawesome-css" media="all">
    <!-- <link rel="stylesheet" href="{{ asset('themes/insur/styleef10.css') }}" id="insur-parent-style-css" media="all"> -->
    <link rel="stylesheet" href="{{ asset('themes/insur-child/styleef10.css') }}" id="insur-style-css" media="all">
...
@font-face {
			font-family: "star";
			src: url("{{ asset('plugins/woocommerce/assets/fonts/star.eot') }}");
    		src: url("{{ asset('plugins/woocommerce/assets/fonts/stard41d.eot') }}?#iefix") format("embedded-opentype"),
         		 url("{{ asset('plugins/woocommerce/assets/fonts/star.woff') }}") format("woff"),
         		 url("{{ asset('plugins/woocommerce/assets/fonts/star.ttf') }}") format("truetype"),
         		 url("{{ asset('plugins/woocommerce/assets/fonts/star.svg') }}#star") format("svg");

			font-weight: normal;
			font-style: normal;
		}
</style>
<link rel="stylesheet" href="{{ asset('themes/insur/assets/vendors/flaticons/css/flaticon4963.css') }}" id="flaticons-css" media="all">
    <link rel="stylesheet" href="{{ asset('themes/insur/assets/vendors/insur-two-icon/style5152.css') }}" id="insur-icons-two-css" media="all">
    <link rel="stylesheet" href="{{ asset('themes/insur/assets/vendors/insur-three-icon/style5152.css') }}" id="insur-three-icon-css" media="all">
    <link rel="stylesheet" href="{{ asset('themes/insur/assets/css/modes/insur-darkefee.css') }}" id="insur-dark-mode-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/recent-posts-widget-with-thumbnails/public03db.css') }}" id="recent-posts-widget-with-thumbnails-public-style-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/elementor/assets/css/frontend-lite.mince8e.css') }}" id="elementor-frontend-css" media="all">
    <link rel="stylesheet" href="{{ asset('uploads/elementor/css/post-13d4fc.css') }}" id="elementor-post-13-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/elementor-pro/assets/css/frontend-lite.min7329.css') }}" id="elementor-pro-css" media="all">
    <link rel="stylesheet" href="{{ asset('uploads/elementor/css/globalccfd.css') }}" id="elementor-global-css" media="all">
    <link rel="stylesheet" href="{{ asset('uploads/elementor/css/post-95324d8.css') }}" id="elementor-post-953-css" media="all">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic%7CRoboto+Slab%3A100%2C100italic%2C200%2C200italic%2C300%2C300italic%2C400%2C400italic%2C500%2C500italic%2C600%2C600italic%2C700%2C700italic%2C800%2C800italic%2C900%2C900italic&amp;display=swap&amp;ver=6.5.3" id="google-fonts-1-css" media="all">
    <link rel="stylesheet" href="{{ asset('plugins/insur-addon/assets/vendors/insur-icons/style5152.css') }}" id="elementor-icons-shared-0-css" media="all">
	...
	<script src="{{ asset('includes/js/jquery/jquery-migrate.min5589.js') }}" id="jquery-migrate-js"></script>
    <script src="{{ asset('plugins/woocommerce/assets/js/jquery-blockui/jquery.blockUI.min71e5.js') }}" id="jquery-blockui-js" defer data-wp-strategy="defer"></script><script id="wc-add-to-cart-js-extra">
var wc_add_to_cart_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View cart","cart_url":"https:\/\/denzel.blec.co.za\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
	...
	<script src="{{ asset('plugins/woocommerce/assets/js/frontend/add-to-cart.min117a.js') }}" id="wc-add-to-cart-js" defer data-wp-strategy="defer"></script>
    <script src="{{ asset('plugins/woocommerce/assets/js/js-cookie/js.cookie.min52f2.js') }}" id="js-cookie-js" defer data-wp-strategy="defer"></script>
<script id="woocommerce-js-extra">
var woocommerce_params = {"ajax_url":"\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/?wc-ajax=%%endpoint%%"};
</script>
<script src="{{ asset('plugins/woocommerce/assets/js/frontend/woocommerce.min117a.js') }}" id="woocommerce-js" defer data-wp-strategy="defer"></script>
...
<!-- Icons -->
	<link rel="icon" href="{{ asset('uploads/2024/04/flavicon-friends4life-16by16px-01.png') }}" sizes="32x32">
    <link rel="icon" href="{{ asset('uploads/2024/04/flavicon-friends4life-16by16px-01.png') }}" sizes="192x192">
    <link rel="apple-touch-icon" href="{{ asset('uploads/2024/04/flavicon-friends4life-16by16px-01.png') }}">
...
Ferndale, Randburg</p>
										...
										<div class="text">
											<p><a href="mailto:info@friends4life.co.za">info@friends4life.co.za</a></p>
										</div>
									</li>
															</ul>
											</div>
					...
					<div class="main-menu__wrapper-inner clearfix">
						<div class="main-menu__left">
							<div class="main-menu__logo">
								<a href="index.html">
									<!-- Image -->
    								<img decoding="async" width="140" height="27" src="{{ asset('uploads/2024/04/main-logo-footer-logo-friends4life-01.png') }}" alt="Friends For Life">
								</a>
							</div>
...
<li id="menu-item-2132" class="menu-item menu-item-type-post_type menu-item-object-page megamenu-hide menu-item-2132"><a href="about/index.html">About</a></li>
...
<div class="mobile-nav__wrapper">
	...
	<div class="mobile-nav__content">
		...
		<div class="logo-box">
			<a href="index.html">
				 <!-- Image -->
				 <img decoding="async" width="140" height="27" src="{{ asset('uploads/2022/07/logo-light.png') }}" id="mobile-thm-logo" alt="Friends For Life">
		...
		<!-- /.mobile-nav__container -->
					<ul class="mobile-nav__contact list-unstyled ml-0">
						...
						<a href="needhelp%40insur.html">needhelp@insur.com</a>
					</li>
													<li>
	...
	<div class="search-popup">
		...
		<div class="search-popup__content">
			<form action="https://denzel.blec.co.za/">
	...
	<a href="#" data-target="html" class="scroll-to-target scroll-to-top"><i class="fa fa-angle-up"></i></a>
				...
				<div class="elementor-element elementor-element-2de17a60 elementor-widget elementor-widget-insur-main-slider" data-id="2de17a60" data-element_type="widget" data-widget_type="insur-main-slider.default">
				<div class="elementor-widget-container">
			
    <!--Main Slider Start-->
    <section class="main-slider clearfix">
        <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 3,
            "loop": true,
            "effect": "fade",
            "pagination": {
    ...
    <!-- Background Image -->
    		<div class="image-layer" style="background-image: url('{{ asset('uploads/2024/04/11.jpg') }}');"></div>
    <!-- /.image-layer -->

    <!-- Slider Shape Image -->
    		<div class="main-slider-shape-1 float-bob-x">
        		<img decoding="async" src="{{ asset('uploads/2022/07/main-slider-shape-1.png') }}" alt="">
    		</div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="main-slider__content">
                                                                                    <h2 class="main-slider__title">With Your Broker <br> for the better <br> family <span>life.</span></h2>
                                                                                                                            <p class="main-slider__text">Our dedicated team takes the time to understand your specific <br> requirements and crafts insurance solutions that align with your goals and budget.</p>
                                                                                                                            <div class="main-slider__btn-box">
                                                <a   href="http://layerdrops.com/insurwp/about/" class="thm-btn main-slider__btn">Let’s Get Started </a>
                                            </div>
                                                                            </div>
                                </div>
                            </div>
                                    ...
                                    <div class="swiper-slide">
                        <!-- Background Image -->
    					<div class="image-layer" style="background-image: url('{{ asset('uploads/2024/04/22.jpg') }}');"></div>
    <!-- /.image-layer -->
    					...
    					<div class="main-slider-shape-1 float-bob-x">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="swiper-slide">
         <!-- Background Image -->
    <div class="image-layer" style="background-image: url('{{ asset('uploads/2024/04/33.jpg') }}');"></div>
    <!-- /.image-layer -->
    ...
    <!--Main Slider End-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-4f60307 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="4f60307" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-32a4a5fb" data-id="32a4a5fb" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-33658360 elementor-widget elementor-widget-insur-features" data-id="33658360" data-element_type="widget" data-widget_type="insur-features.default">
				<div class="elementor-widget-container">
				<!--Feature One Start-->
				...
				<div class="row">
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
							<div class="feature-one__single">
								<div class="feature-one__single-inner">
									<div class="feature-one__icon insur-icon-svg">
										<span aria-hidden="true" class="  icon-insurance"></span>									</div>
									<div class="feature-one__count"></div>
									<div class="feature-one__shape">
										<img decoding="async" src="{{ asset('uploads/2022/07/feature-one-shape-1.png') }}" alt="">

									</div>
									<h3 class="feature-one__title">
																					<a   href="http://layerdrops.com/insurwp/about/">Personalized Service</a>
																			</h3>
									<p class="feature-one__text">We take the time to understand your unique needs and goals, crafting customized insurance solutions.</p>
								</div>
							</div>
						</div>
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
							<div class="feature-one__single">
								<div class="feature-one__single-inner">
									<div class="feature-one__icon insur-icon-svg">
										<span aria-hidden="true" class="   icon-cashback"></span>									</div>
									<div class="feature-one__count"></div>
									<div class="feature-one__shape">
									<img decoding="async" src="{{ asset('uploads/2022/07/feature-one-shape-1.png') }}" alt="">
									</div>
									<h3 class="feature-one__title">
																					<a   href="http://layerdrops.com/insurwp/about/">Wide Range of Products</a>
																			</h3>
									<p class="feature-one__text">From life insurance, health insurance, home insurance, auto insurance we've got you covered</p>
								</div>
							</div>
						</div>
						<!--Feature One Single End-->
						...
						<div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
							<div class="feature-one__single">
								<div class="feature-one__single-inner">
									<div class="feature-one__icon insur-icon-svg">
										<span aria-hidden="true" class="   icon-house"></span>									</div>
									<div class="feature-one__count"></div>
									<div class="feature-one__shape">
									<img decoding="async" src="{{ asset('uploads/2022/07/feature-one-shape-1.png') }}" alt="">
									...
									<h3 class="feature-one__title">
																					<a   href="http://layerdrops.com/insurwp/about/">Expert Guidance</a>
																			</h3>
									<p class="feature-one__text">Navigating the world of insurance can be overwhelming. That's where we come in.</p>
								</div>
							</div>
						</div>
						<!--Feature One Single End-->
	...
	<!--Feature One End-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-317b4014 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="317b4014" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-2e7db1f5" data-id="2e7db1f5" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-7b41a2db elementor-widget elementor-widget-insur-about" data-id="7b41a2db" data-element_type="widget" data-widget_type="insur-about.default">
				<div class="elementor-widget-container">
				<!--About One Start-->
	<section class="about-one">
					<div class="about-one-bg wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms" style="background-image: url(../layerdrops.com/insurwp/wp-content/uploads/2022/07/about-one-bg-1.png);"></div>
				<div class="container">
			<div class="row">
				<div class="col-xl-6">
    ...
    <div class="about-one__img">
        <img decoding="async" src="{{ asset('uploads/2024/04/The-best.jpg') }}" alt="">
    </div>

    <!-- Image 2 -->
    <div class="about-one__img-two">
        <img decoding="async" src="{{ asset('uploads/2024/04/The-best-2.jpg') }}" alt="">
    </div>
    ...
    <div class="about-one__shape-1">
        <img decoding="async" src="{{ asset('uploads/2022/07/about-one-shape-1.png') }}" alt="">
    </div>
													</div>
					</div>
				</div>
        ...
        <div class="section-title-shape-1">
            <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-1-1.png') }}" alt="">
        </div>
        <div class="section-title-shape-2">
            <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-2-1.png') }}" alt="">
        </div>
    </div>
																	</div>
																	<h2 class="section-title__title">We understand that life is full of uncertainties</h2>
															</div>
																			<p class="about-one__text-1"> That's why we're here to provide you with the peace of mind you deserve. </p>
																			<ul class="list-unstyled about-one__points ml-0">
																	<li>
										<div class="icon insur-icon-svg">
											<i aria-hidden="true" class="  fa fa-check"></i>										</div>
										<div class="text">
											<p>Ongoing support and assistance</p>
										</div>
									</li>
																	<li>
										<div class="icon insur-icon-svg">
											<i aria-hidden="true" class="  fa fa-check"></i>										</div>
										<div class="text">
											<p>Access to multiple insurance carriers</p>
										</div>
									</li>
																	<li>
										<div class="icon insur-icon-svg">
											<i aria-hidden="true" class="  fa fa-check"></i>										</div>
										<div class="text">
											<p>Helping you make informed decisions</p>
										</div>
									</li>
															</ul>
								...
								<div class="about-one__call-icon insur-icon-svg">
									<i aria-hidden="true" class="  fas fa-phone"></i>								</div>
																	<div class="about-one__call-content">
																					<a href="tel:9200368090">+27 (10) 500 0069</a>
																															<p>Call to Our Experts</p>
																			</div>
															</div>
						</div>
	...
	<!--About One End-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-20bee047 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="20bee047" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-2d6e8b0f" data-id="2d6e8b0f" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-500b3ff9 elementor-widget elementor-widget-insur-service" data-id="500b3ff9" data-element_type="widget" data-widget_type="insur-service.default">
				<div class="elementor-widget-container">
			...
			<div class="container">
				<div class="row">
							...
							<div class="services-one__top-left">
								<div class="section-title text-left">
																			<div class="section-sub-title-box">
											<p class="section-sub-title">OUR SERVICES
</p>
<div class="section-title-shape-1">
    <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-1-1.png') }}" alt="2011">
</div>
<div class="section-title-shape-2">
    <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-2-1.png') }}" alt="2010">
</div>

										</div>
																												<h2 class="section-title__title">We cover a wide range of products</h2>
																	</div>
							</div>
						</div>
																<div class="col-xl-7 col-lg-6">
							<div class="services-one__top-right">
								<p class="services-one__top-text">As a trusted insurance broker, we specialize in providing personalized insurance solutions tailored to your unique needs.</p>
							</div>
						</div>
									</div>
			</div>
				...
				<div class="row">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
										...
										<img decoding="async" src="{{ asset('uploads/2024/04/services-1-1.jpg') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/Medical-Insurance.png') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/Pet-Insurance.png') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/Building-Insurance.png') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/Camera-insurance.png') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/Accident-Cover.png') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/mid-section-unrecognizable-entrepreneur-texting-messages-break-scaled.jpg') }}" alt="">
							...
							<div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
								<div class="services-one__single">
																			<div class="service-one__img">
										<img decoding="async" src="{{ asset('uploads/2024/04/car-warranty.png') }}" alt="">
	...
	<!--Services One End-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-24970011 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="24970011" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-3adafa68" data-id="3adafa68" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-6a4591be elementor-widget elementor-widget-insur-about" data-id="6a4591be" data-element_type="widget" data-widget_type="insur-about.default">
				<div class="elementor-widget-container">
				<!--Why Choose One Start-->
	<section class="why-choose-one">
					<div class="why-choose-one-shape-1" style="background-image: url(wp-content/uploads/2024/04/why-choose-one-shape-6-1.png);"></div>
					<div class="why-choose-one-shape-2 float-bob-y">
    <img decoding="async" src="{{ asset('wp-content/uploads/2024/04/why-choose-one-shape-2-2.png') }}" alt="">
</div>
<div class="why-choose-one-shape-3 float-bob-x">
    <img decoding="async" src="{{ asset('uploads/2024/04/why-choose-one-shape-3-1.png') }}" alt="">
</div>
<div class="why-choose-one-shape-4 float-bob-y">
    <img decoding="async" src="{{ asset('uploads/2024/04/why-choose-one-shape-4-1.png') }}" alt="">
</div>
<div class="why-choose-one-shape-5 float-bob-y">
    <img decoding="async" src="{{ asset('uploads/2024/04/why-choose-one-shape-5-1.png') }}" alt="">
</div>
<div class="why-choose-one-shape-6 float-bob-x">
    <img decoding="async" src="{{ asset('uploads/2024/04/why-choose-one-shape-2-3.png') }}" alt="">
</div>
<div class="why-choose-one-img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
    <img decoding="async" src="{{ asset('uploads/2024/04/tri.png') }}" alt="">
</div>
...
<div class="section-title-shape-2">
    <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-2-1.png') }}" alt="">
																			...
																			<p class="why-choose-one__text">Discover why so many individuals and businesses trust Friends4Life for their insurance needs. </p>
								...
								<ul class="list-unstyled why-choose-one__list">
											...
											<div class="why-choose-one__single">
												...
												<div class="why-choose-one__list-title-box">
													<div class="why-choose-one__list-title-inner">
														<h3 class="why-choose-one__list-title">Exceptional Service</h3>
													</div>
											...
											<div class="why-choose-one__single">
												<div class="why-choose-one__list-icon insur-icon-svg">
													<span aria-hidden="true" class="   icon-policy"></span>												</div>
												<div class="why-choose-one__list-title-box">
													<div class="why-choose-one__list-title-inner">
	...
	<!--Why Choose One End-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-4ac0c34f elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="4ac0c34f" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-17e16280 elementor-widget elementor-widget-insur-contact-form" data-id="17e16280" data-element_type="widget" data-widget_type="insur-contact-form.default">
				<div class="elementor-widget-container">
			    <!--Get Insurance Start-->
    <section class="get-insurance">
                    <<div class="get-insurance-bg" style="background-image: url({{ asset('uploads/2022/07/get-insurance-bg.png') }});"></div>
                <div class="container">
            <div class="row">
                    ...
                    <div class="get-insurance__left">
                                ...
                                <p>Friends 4 Life</p>
                                                ...
                                                <div class="get-insurance__circle"></div>
													...
													<div class="get-insurance-bg" style="background-image: url('layerdrops.com/insurwp/wp-content/uploads/2022/07/get-insurance-bg.png');"></div>
                ...
                <div class="col-xl-6">
                    <div class="get-insurance__right">
                                                    <div class="section-title text-left">
                                                                    <div class="section-sub-title-box">
                                        <p class="section-sub-title">Get a Free Estimate </p>
										<div class="section-title-shape-1">
    <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-1-1.png') }}" alt="2011">
</div>
<div class="section-title-shape-2">
    <img decoding="async" src="{{ asset('uploads/2024/04/section-title-shape-2-1.png') }}" alt="2010">
                                                                                                    ...
                                                                                                    <h2 class="section-title__title">Get an insurance quote
to get started!</h2>
                                                            </div>
                                ...
                                <div class="tabs-content">
                                        ...
                                        <div class="tab active-tab" id="Home">
                                            <div class="get-insurance__content">
                                                                                                    <div class="wpcf7 no-js" id="wpcf7-f101-p953-o1" lang="en-US" dir="ltr">
...
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f101-p953-o1" />
...
<p><span class="wpcf7-form-control-wrap" data-name="text-760"><input size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Full name" value="" type="text" name="text-760" /></span>
			</p>
</p></div>
<div class="get-insurance__input-box">
<p><span class="wpcf7-form-control-wrap" data-name="email-54"><input size="40" class="wpcf7-form-control wpcf7-email wpcf7-validates-as-required wpcf7-text wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email" value="" type="email" name="email-54" /></span>
			</p>
</p></div>
<div class="get-insurance__input-box">
...
<p><input type="text" class="balance-range-slider"
...
<p><button type="submit" class="thm-btn get-insurance__btn">Get a Quote Now</button>
	</p>
</div>
<div class="wpcf7-response-output" aria-hidden="true"></div>
                                        ...
                                        <div class="tab " id="Vehicles">
                                            <div class="get-insurance__content">
                                                                                                    <div class="wpcf7 no-js" id="wpcf7-f101-p953-o2" lang="en-US" dir="ltr">
<div class="screen-reader-response">
<p role="status" aria-live="polite" aria-atomic="true">
<ul></ul>
</div>
<form action="https://denzel.blec.co.za/#wpcf7-f101-p953-o2" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="101" />
<input type="hidden" name="_wpcf7_version" value="5.9.3" />
<input type="hidden" name="_wpcf7_locale" value="en_US" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f101-p953-o2" />
<input type="hidden" name="_wpcf7_container_post" value="953" />
<input type="hidden" name="_wpcf7_posted_data_hash" value="" />
</div>
<div class="get-insurance__form">
...
<div class="wpcf7-response-output" aria-hidden="true"></div>
                                        ...
                                        <div class="tab " id="Health">
                                            <div class="get-insurance__content">
                                                                                                    <div class="wpcf7 no-js" id="wpcf7-f101-p953-o3" lang="en-US" dir="ltr">
<div class="screen-reader-response">
<p role="status" aria-live="polite" aria-atomic="true">
<ul></ul>
</div>
...
<input type="hidden" name="_wpcf7_version" value="5.9.3" />
<input type="hidden" name="_wpcf7_locale" value="en_US" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f101-p953-o3" />
<input type="hidden" name="_wpcf7_container_post" value="953" />
<input type="hidden" name="_wpcf7_posted_data_hash" value="" />
</div>
<div class="get-insurance__form">
...
<div class="wpcf7-response-output" aria-hidden="true"></div>
                                        ...
                                        <div class="tab " id="Life">
                                            <div class="get-insurance__content">
                                                                                                    <div class="wpcf7 no-js" id="wpcf7-f101-p953-o4" lang="en-US" dir="ltr">
<div class="screen-reader-response">
<p role="status" aria-live="polite" aria-atomic="true">
<ul></ul>
</div>
<form action="https://denzel.blec.co.za/#wpcf7-f101-p953-o4" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
<div style="display: none;">
<input type="hidden" name="_wpcf7" value="101" />
<input type="hidden" name="_wpcf7_version" value="5.9.3" />
<input type="hidden" name="_wpcf7_locale" value="en_US" />
<input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f101-p953-o4" />
<input type="hidden" name="_wpcf7_container_post" value="953" />
<input type="hidden" name="_wpcf7_posted_data_hash" value="" />
</div>
<div class="get-insurance__form">
...
<div class="wpcf7-response-output" aria-hidden="true"></div>
    ...
    <!--Get Insurance End-->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-9100fbe elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="9100fbe" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-720e711c" data-id="720e711c" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
						<div class="elementor-element elementor-element-16207675 elementor-widget elementor-widget-insur-funfact" data-id="16207675" data-element_type="widget" data-widget_type="insur-funfact.default">
				<div class="elementor-widget-container">
				<!--Counter One Start-->
	<Section class="counter-one">
	<div class="counter-one-shape-1 float-bob-y">
    <img decoding="async" src="{{ asset('uploads/2022/07/counter-one-shape-1.png') }}" alt="">
</div>
<div class="counter-one-shape-2 float-bob-y">
    <img decoding="async" src="{{ asset('uploads/2022/07/counter-one-shape-2.png') }}" alt="">
</div>
	...
	<!--Counter One End-->
		...
		<div class="footer-widget__logo">
			<a href="index.html">
			<img decoding="async" width="251" height="60" src="{{ asset('uploads/2024/04/main-logo-footer-logo-friends4life-01.png') }}" alt="Friends For Life">
			</a>
		</div>
					<div class="footer-widget__about-text-box">
				<p class="footer-widget__about-text">For any and all information required please don not hesitate to contact us using the details provided.</p>
			</div>
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<ul class="footer-widget__contact-list list-unstyled clearfix ml-0">
					...
					<div class="text">
						<p>Address: Block B, Oak Office Park
372 Oak Avenue
Ferndale, Randburg</p>
					</div>
				</li>
				...
				<h3 class="footer-widget__open-hour-text">Mon – Sat: 9:00 am to 5:00 pm Sunday:
                                        Closed</h3>
			</div>
			</div>
		</div>
...
latest update &amp; news.</p>
		...
		<div class="row">
			<div class="col-xl-12">
						...
						<p class="site-footer__bottom-text">© Copyright 2024 Friends For Life Intermediary Services FSP (No. 46217) </p>
					</div>
							</div>
		</div>
	</div>
	...
	<link rel='stylesheet' id='elementor-post-668-css' href='uploads/elementor/css/post-668f83c.css?ver=1713177722' media='all' />
<script src="plugins/yith-woocommerce-wishlist/assets/js/jquery.selectBox.min7359.js?ver=1.2.0" id="jquery-selectBox-js"></script>
<script src="plugins/woocommerce/assets/js/prettyPhoto/jquery.prettyPhoto.min005e.js?ver=3.1.6" id="prettyPhoto-js" data-wp-strategy="defer"></script>
...
<script src="plugins/yith-woocommerce-wishlist/assets/js/jquery.yith-wcwl.min575b.js?ver=3.31.0" id="jquery-yith-wcwl-js"></script>
<script src="plugins/contact-form-7/includes/swv/js/index7404.js?ver=5.9.3" id="swv-js"></script>
<script id="contact-form-7-js-extra">
var wpcf7 = {"api":{"root":"https:\/\/denzel.blec.co.za\/wp-json\/","namespace":"contact-form-7\/v1"}};
</script>
<script src="plugins/contact-form-7/includes/js/index7404.js?ver=5.9.3" id="contact-form-7-js"></script>
<script src="plugins/woocommerce/assets/js/sourcebuster/sourcebuster.min117a.js?ver=8.7.0" id="sourcebuster-js-js"></script>
...
<!-- JavaScript files -->
    <script src="{{ asset('plugins/woocommerce/assets/js/frontend/order-attribution.min117a.js') }}" id="wc-order-attribution-js"></script>
    <script src="{{ asset('themes/insur/assets/vendors/bootstrap/js/bootstrap.minbb93.js') }}" id="bootstrap-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/bootstrap-select/js/bootstrap-select.mind4b5.js') }}" id="bootstrap-select-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/bxslider/jquery.bxslider.mind4b5.js') }}" id="jquery-bxslider-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/countdown/countdown.mind4b5.js') }}" id="countdown-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/isotope/isotoped4b5.js') }}" id="isotope-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/jarallax/jarallax.mind4b5.js') }}" id="jarallax-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.mind4b5.js') }}" id="jquery-ajaxchimp-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/jquery-appear/jquery.appear.mind4b5.js') }}" id="jquery-appear-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/jquery-easing/jquery.easing.mind4b5.js') }}" id="jquery-easing-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.mind4b5.js') }}" id="jquery-magnific-popup-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/jquery-circle-progress/jquery.circle-progress.mind4b5.js') }}" id="jquery-circle-progress-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/odometer/odometer.mind4b5.js') }}" id="odometer-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/owl-carousel/owl.carousel.mind4b5.js') }}" id="owl-carousel-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/swiper/swiper.mind4b5.js') }}" id="swiper-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/ion.rangeSlider/js/ion.rangeSlider.mind4b5.js') }}" id="rangeSlider-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/wow/wowd4b5.js') }}" id="wow-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/sharer/sharer.mind4b5.js') }}" id="sharer-js"></script>
    <script src="{{ asset('plugins/insur-addon/assets/vendors/nice-select/jquery.nice-select.mind4b5.js') }}" id="nice-select-js"></script>
...
var insur_login_object = {"ajaxurl":"https:\/\/denzel.blec.co.za\/wp-admin\/admin-ajax.php","login_redirect_url":"https:\/\/denzel.blec.co.za\/","registration_redirect_url":"https:\/\/denzel.blec.co.za\/","message":"<strong>Error:<\/strong>Please use valid userName or password","check_login":"no","str_login":"Please login to add favorite!","str_add_wishlist":"Add favorite successfully!","str_remove_wishlist":"Remove favorite successfully!"};
 ...
 <!-- JavaScript files -->
 	<script src="{{ asset('plugins/insur-addon/assets/js/insur-addond4b5.js') }}" id="insur-addon-script-js"></script>
    <script src="{{ asset('themes/insur/assets/js/insur-themeefee.js') }}" id="insur-theme-js"></script>
    <script src="{{ asset('plugins/elementor-pro/assets/js/webpack-pro.runtime.min7329.js') }}" id="elementor-pro-webpack-runtime-js"></script>
    <script src="{{ asset('plugins/elementor/assets/js/webpack.runtime.mince8e.js') }}" id="elementor-webpack-runtime-js"></script>
    <script src="{{ asset('plugins/elementor/assets/js/frontend-modules.mince8e.js') }}" id="elementor-frontend-modules-js"></script>
    ...
    <script src="{{ asset('js/dist/hooks.min2757.js') }}" id="wp-hooks-js"></script>
    <script src="{{ asset('js/dist/i18n.minc33c.js') }}" id="wp-i18n-js"></script>
...
var ElementorProFrontendConfig = {"ajaxurl":"https:\/\/denzel.blec.co.za\/wp-admin\/admin-ajax.php","nonce":"68396661be","urls":{"assets":"https:\/\/denzel.blec.co.za\/wp-content\/plugins\/elementor-pro\/assets\/","rest":"https:\/\/denzel.blec.co.za\/wp-json\/"},"shareButtonsNetworks":{"facebook":{"title":"Facebook","has_counter":true},"twitter":{"title":"Twitter"},"linkedin":{"title":"LinkedIn","has_counter":true},"pinterest":{"title":"Pinterest","has_counter":true},"reddit":{"title":"Reddit","has_counter":true},"vk":{"title":"VK","has_counter":true},"odnoklassniki":{"title":"OK","has_counter":true},"tumblr":{"title":"Tumblr"},"digg":{"title":"Digg"},"skype":{"title":"Skype"},"stumbleupon":{"title":"StumbleUpon","has_counter":true},"mix":{"title":"Mix"},"telegram":{"title":"Telegram"},"pocket":{"title":"Pocket","has_counter":true},"xing":{"title":"XING","has_counter":true},"whatsapp":{"title":"WhatsApp"},"email":{"title":"Email"},"print":{"title":"Print"},"x-twitter":{"title":"X"},"threads":{"title":"Threads"}},"woocommerce":{"menu_cart":{"cart_page_url":"https:\/\/denzel.blec.co.za\/cart\/","checkout_page_url":"https:\/\/denzel.blec.co.za\/checkout\/","fragments_nonce":"1a05007c09"}},"facebook_sdk":{"lang":"en_US","app_id":""},"lottie":{"defaultAnimationUrl":"https:\/\/denzel.blec.co.za\/wp-content\/plugins\/elementor-pro\/modules\/lottie\/assets\/animations\/default.json"}};
 ...
 <!-- JavaScript files -->
 	<script src="{{ asset('plugins/elementor-pro/assets/js/frontend.min7329.js') }}" id="elementor-pro-frontend-js"></script>
    <script src="{{ asset('plugins/elementor/assets/lib/waypoints/waypoints.min05da.js') }}" id="elementor-waypoints-js"></script>
    <script src="{{ asset('js/jquery/ui/core.min3f14.js') }}" id="jquery-ui-core-js"></script><script id="elementor-frontend-js-before">
...
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close","a11yCarouselWrapperAriaLabel":"Carousel | Horizontal scrolling: Arrow Left & Right","a11yCarouselPrevSlideMessage":"Previous slide","a11yCarouselNextSlideMessage":"Next slide","a11yCarouselFirstSlideMessage":"This is the first slide","a11yCarouselLastSlideMessage":"This is the last slide","a11yCarouselPaginationBulletMessage":"Go to slide"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile Portrait","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Landscape","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet Portrait","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Landscape","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}}},"version":"3.20.3","is_static":false,"experimentalFeatures":{"e_optimized_assets_loading":true,"e_optimized_css_loading":true,"e_font_icon_svg":true,"additional_custom_breakpoints":true,"container":true,"e_swiper_latest":true,"container_grid":true,"theme_builder_v2":true,"block_editor_assets_optimize":true,"ai-layout":true,"landing-pages":true,"e_image_loading_optimization":true,"notes":true,"display-conditions":true,"form-submissions":true,"taxonomy-filter":true},"urls":{"assets":"https:\/\/denzel.blec.co.za\/wp-content\/plugins\/elementor\/assets\/"},"swiperClass":"swiper","settings":{"page":[],"editorPreferences":[]},"kit":{"active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description","woocommerce_notices_elements":[]},"post":{"id":953,"title":"Home%20Dark%20-%20Friends%20For%20Life","excerpt":"","featuredImage":false}};
	...
	<script src="{{ asset('plugins/elementor/assets/js/frontend.mince8e.js') }}" id="elementor-frontend-js"></script>
    <script src="{{ asset('plugins/elementor-pro/assets/js/elements-handlers.min7329.js') }}" id="pro-elements-handlers-js"></script>
    <script src="{{ asset('js/underscore.mind584.js') }}" id="underscore-js"></script>
<script id="wp-util-js-extra">
var _wpUtilSettings = {"ajax":{"url":"\/wp-admin\/admin-ajax.php"}};
</script>
<script src="{{ asset('js/wp-util.minef10.js') }}" id="wp-util-js"></script>
<script id="wpforms-elementor-js-extra">
var wpformsElementorVars = {"captcha_provider":"recaptcha","recaptcha_type":"v2"};
</script>
<script src="{{ asset('plugins/wpforms-lite/assets/js/integrations/elementor/frontend.min5068.js') }}" id="wpforms-elementor-js"></script>
