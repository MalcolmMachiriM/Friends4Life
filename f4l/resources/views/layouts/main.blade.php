			...
			<div class="container">
				<div class="main-header__top-inner">
					<div class="main-header__top-address">
										...
										<div class="text">
											<p>
											360 Oak AveFerndale, Randburg, 2194
										</p>
										</div>
									</li>
																	<li>
					...
					<div class="main-header__top-right">
								...
								<div class="main-header__top-social">
																			<a class="insur-icon-svg" href="https://twitter.com/friends4life_za" target=_blank>
											<svg aria-hidden="true" class="  e-font-icon-svg e-fab-twitter" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z"></path></svg>										</a>
																			<a class="insur-icon-svg" href="https://facebook.com/Friends4LifeBrokers" target=_blank>
											<i aria-hidden="true" class="  fab fa-facebook-f"></i>										</a>
																			<a class="insur-icon-svg" href="https://tiktok.com/@friends4life_broker" target=_blank>
																			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M448 209.9a210.1 210.1 0 0 1 -122.8-39.3V349.4A162.6 162.6 0 1 1 185 188.3V278.2a74.6 74.6 0 1 0 52.2 71.2V0l88 0a121.2 121.2 0 0 0 1.9 22.2h0A122.2 122.2 0 0 0 381 102.4a121.4 121.4 0 0 0 67 20.1z"/></svg>										</a>
																			<a class="insur-icon-svg" href="http://instagram.com/friends4life_za" target=_blank>
...
<li id="menu-item-2132" class="menu-item menu-item-type-post_type menu-item-object-page megamenu-hide menu-item-2132"><a href="{{ route('about.index') }}">About Us</a></li>
								...
								<div class="main-menu__call-icon insur-icon-svg">
									<i aria-hidden="true" class="  fas fa-phone"></i>								</div>
																	<div class="main-menu__call-content">
																					<a href="tel:+27105000069">010 500 0069</a>
		...
		<div class="footer-widget__logo">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<ul class="footer-widget__contact-list list-unstyled clearfix ml-0">
					...
					<div class="text">
						<p>Address: 360 Oak Avenue, Ferndale, Randburg, 2194</p>
					</div>
				</li>
					</ul>
                            ...
                            <div class="get-insurance__progress">
                                ...
                                <div class="get-insurance__progress-range">
                                    ...
                                    <div class="get-insurance__balance-box">
                                        <p class="get-insurance__balance">R<span></span></p>
                                    </div>
